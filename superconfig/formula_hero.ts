...
		public GetLevel() : number|undefined { //等级
			return this.get(1003);
		}
		public SetLevel(v:number) {//等级
			this.set(1003,v);
		}
		public GetRatio() : number|undefined { //成长
			return this.get(2003);
		}
		public SetRatio(v:number) {//成长
			this.set(2003,v);
		}
		public GetMaxhp() : number|undefined { //最大血量
